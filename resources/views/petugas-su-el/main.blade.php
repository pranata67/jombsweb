        ...
        <div class="col-xl-12 \">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Data Petugas SU EL</h3>
...
<script type="text/javascript">
    ...
    function addRow(){
        $.post("{!! route('form-petugas-su-el') !!}").done(function(data){
    ...
    function deleteRow(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("delete-petugas-su-el") }}',
                    method: 'POST',
                    data: {
                        _method: 'POST',
                        _token: '{{ csrf_token() }}',
