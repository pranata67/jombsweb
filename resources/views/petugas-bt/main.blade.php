        ...
        <div class="col-xl-12 \">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Data Petugas BT</h3>
...
<script type="text/javascript">
    ...
    function addRow(){
        $.post("{!! route('form-petugas-bt') !!}").done(function(data){
