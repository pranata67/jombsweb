...
@section('breadcrumb')
	@parent
	<li class="active">Operator BPN</li>
@endsection
        ...
        <div class="col-xl-12 \">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Data Operator BPN</h3>
...
<script type="text/javascript">
    ...
    function addRow(){
        $.post("{!! route('form-operator-bpn') !!}").done(function(data){
