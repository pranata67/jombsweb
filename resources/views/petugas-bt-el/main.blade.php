...
@section('breadcrumb')
	@parent
	<li class="active">Petugas BT EL</li>
@endsection
        ...
        <div class="col-xl-12 \">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Data Petugas BT EL</h3>
                ...
                <div class="block-content" style="padding-bottom: 20px !important">
                    ...
                    <table id="datagrid" class="table table-bordered table-striped table-hover table-responsive" style="width: 100%">
                        <thead class="">
                            <tr>
                                <th class="text-center fs-xs" style="width: 5%;">No</th>
...
<script type="text/javascript">
    ...
    function addRow(){
        $.post("{!! route('form-petugas-bt-el') !!}").done(function(data){
    ...
    function deleteRow(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("delete-petugas-bt-el") }}',
                    method: 'POST',
                    data: {
                        _method: 'POST',
                        _token: '{{ csrf_token() }}',
    ...
    function resetPw(id) {
        Swal.fire({
            title: 'Password akun akan direset!!',
