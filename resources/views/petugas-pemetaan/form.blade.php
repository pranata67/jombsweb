    ...
    <div class="modal-dialog modal-dialog-popout modal-dialog-centered modal-lg" role="document">
        ...
        <div class="block block-rounded block-themed block-transparent mb-0">
            <div class="block-header">
                <h3 class="block-title">{{ $data ? 'Edit' : 'Tambah' }} Petugas Pemetaan</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="no_telepon" id="no_telepon" @if (!empty($data)) value="{{ $data->no_telepon }}"  @endif class="form-control" placeholder="0822637274405">
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="jabatan" id="jabatan" @if (!empty($data)) value="{{ $data->jabatan }}" @endif class="form-control" placeholder="Petugas Pemetaan">
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                                <label for="" class="fs-sm">Username</label>
                                <input type="text" name="username" id="username" @if (!empty($data)) value="{{ $data->email }}"  @endif class="form-control" placeholder="jhondoe@gmail.com">
                            </div>
                        </div>
                        @if (empty($data))
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#btn-submit').click(function () {
            ...
            $.ajax({
                data: data,
                url: "{{ route('store-petugas-pemetaan') }}",
                type: "post",
                processData: false,
                contentType: false,
