        ...
        <div class="col-xl-12 \">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Data Petugas Pemetaan</h3>
...
<script type="text/javascript">
    ...
    new DataTable('#datagrid', {
        ajax: "{{ route('main-petugas-pemetaan') }}",
        processing: true,
        serverSide: true,
        language: {
    ...
    function addRow(){
        $.post("{!! route('form-petugas-pemetaan') !!}").done(function(data){
    ...
    function editForm(id){
        console.log('edit');
        $.post("{!! route('form-petugas-pemetaan') !!}", {
            id: id
        }).done(function(data) {
            if (data.status == 'success') {
                $('.modal-page').html('');
    ...
    function deleteRow(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("delete-petugas-pemetaan") }}',
                    method: 'POST',
                    data: {
                        _method: 'POST',
                        _token: '{{ csrf_token() }}',
