        ...
        <div class="block block-rounded">
            ...
            <div class="block-content">
                <form class="form-save" enctype="multipart/form-data">
                    ...
                    @endif
                    <div class="row">
                        <input type="hidden" name="no_registrasi" id="no_registrasi" value="{{ $data ? $data->no_permohonan : $no_permohonan }}">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_sertifikat" id="no_sertifikat" class="form-control form-control-sm" placeholder="00001" value="{{ $data ? $data->no_sertifikat : '' }}" maxlength="5">
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="pendukung-preview"></div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        if(dataPermohonan){
            ...
            setTimeout(() => {
                // console.log(['desa_id',dataPermohonan.desa_id]);
            ...
            if (dataPermohonan.file_sertifikat){
                ...
                if(dataPermohonan.file_sertifikat){
                    ...
                    <div style="display:flex; justify-content:space-between;">
                        <p style="margin:0;"> ${dataPermohonan.file_sertifikat.length > 40 ? dataPermohonan.file_sertifikat.substring(20, 70) + "..." : dataPermohonan.file_sertifikat}</p>
                        <div>
                            <a href="${dataPermohonan.file_sertifikat}" target="__blank">Lihat</a>
                ...
                //     sertif = `
                //     <div style="display:flex; justify-content:space-between;">
                //         <p style="margin:0;"> ${dataPermohonan.file_sertifikat.length > 40 ? dataPermohonan.file_sertifikat.substring(0, 40) + "..." : dataPermohonan.file_sertifikat}</p>
                //         <div>
                ...
                var path_pendukung = "{{ asset('') }}";
                var pendukung = '';
                if(dataPermohonan.file_pendukung){
                    dataPermohonan.file_pendukung.forEach((v,i)=>{
                        pendukung += `
                        <div style="display:flex; justify-content:space-between;">
                            <p style="margin:0;"> ${v.length > 40 ? v.substring(20, 70) + "..." : v}</p>
                            <div>
                                <a href="${path_pendukung.substring(0, path_pendukung.length-1)+v}" target="__blank">Lihat</a>
                                <a href="javascript:void(0);" class="remove-btn delete" data-id="${dataPermohonan.id_permohonan}" onclick="deleteSertif(this.dataset.id)">Hapus</a>
                            </div>
                        </div>
                        `
                    })
                    // pendukung = `${dataPermohonan.file_pendukung}`;
                    // pendukung = `
                    // <div style="display:flex; justify-content:space-between;">
                    //     <p style="margin:0;"> ${dataPermohonan.file_pendukung.length > 40 ? dataPermohonan.file_pendukung.substring(2, 40) + "..." : dataPermohonan.file_pendukung}</p>
                    //     <div>
                    //         <a href="${dataPermohonan.file_pendukung.includes('[') ? path+dataPermohonan.file_pendukung.substring(2, dataPermohonan.file_pendukung.length - 2) : path+dataPermohonan.file_pendukung}" target="__blank">Lihat</a>
                    //         <a href="javascript:void(0);" class="remove-btn delete" data-id="${dataPermohonan.id_permohonan}" onclick="deleteSertif(this.dataset.id)">Hapus</a>
                    //     </div>
                    // </div>
                    // `
                }else{
                    pendukung = 'file tidak tersedia';
                }
                $('.pendukung-preview').html(pendukung);
            ...
            dataPermohonanImages.forEach((v, i) => {
                if(v.file_gambar_exists === 1){
                    ...
                    <div class="img-container" data-index="${v.id_permohonan_images}" style="display: flex; justify-content:space-between;">
                        <p style="margin:0;">${v.gambar.length > 40 ? v.gambar.substring(0, 50) + "..." : v.gambar}</p>
                        <div>
