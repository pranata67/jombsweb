    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header modal-header-kerjakan">
                ...
                <h5 class="modal-title">PENGERJAAN BT</h5>
            ...
            <form class="form-save">
                ...
                <div class="modal-body pb-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-4">
                                <input type="text" class="form-control" id="terakhir_dikerjakan_oleh" name="terakhir_dikerjakan_oleh" placeholder="Terakhir Dikerjakan Oleh" value="{{
                                    ($data->kerjakan_permohonan_bt && $data->kerjakan_permohonan_bt->user)
                                    ? $data->kerjakan_permohonan_bt->user->name
                                    : ''
                                }}" readonly="">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-4">
                                <input type="text" class="form-control" id="terakhir_diupdate" name="terakhir_diupdate" placeholder="Terakhir Diupdate" value="{{
                                    ($data->kerjakan_permohonan_bt)
                                    ? $data->kerjakan_permohonan_bt->created_at
                                    : ''
                                }}" readonly="">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-4">
                                <input type="text" class="form-control" id="petugas_bt" name="petugas_bt" placeholder="Petugas SU El" value="{{ Auth::getUser()->name }}" readonly="">
                                <label for="petugas_bt">Petugas BT</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating mb-4">
                                <select name="upload_bt" id="upload_bt" class="form-control form-control-sm">
                                    ...
                                    <option value="Tolak dan Kembalikan Berkas" {{ ($data && $data->upload_bt == 'Tolak dan Kembalikan Berkas') ? 'selected' : '' }}>Tolak dan Kembalikan Berkas</option>
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-floating mb-4">
                                ...
                                <br>
                                <br>
                                <div style="min-height: 200px" id="editor">{{ $data ? $data->catatan_bt : '' }}</div>
                                <textarea class="form-control" name="catatan_bt" id="catatan_bt_teks" style="display: none;"></textarea>
                                <input type="hidden" name="catatan_bt" id="catatan_bt_teks">
                                {{-- <input type="text" class="form-control" id="catatan_bt" name="catatan_bt" placeholder="Catatan" value="{{ $data ? $data->catatan_bt : '' }}" required>
                                <label for="catatan_bt">Catatan Petugas</label> --}}
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $('.form-save').submit(function(e){
        ...
        // var content = document.querySelector('textarea[id=catatan_bt_teks]');
        var content = document.querySelector('input[id=catatan_bt_teks]');
        content.value = quill.root.innerHTML;

        var data = new FormData(this);
        data.append('petugas','bt');
        $.ajax({
            type: "post",
            url: "{!! route('kerjakan') !!}",
            data: data,
    ...
    $(document).ready(function () {
        $('.form-save #upload_bt').change(function() {
            var selectedValue = $(this).val();
            if (selectedValue === 'Tolak dan Kembalikan Berkas') {
                $('.form-save #catatan_bt').attr('required', '');
            } else {
                $('.form-save #catatan_bt').removeAttr('required');
            }
        });
    })
