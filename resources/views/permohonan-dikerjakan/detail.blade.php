{{-- <div class="modal fade modal-page" id="modal_detail" tabindex="-1" role="dialog" aria-labelledby="modal-block-popout" aria-hidden="true">
    <div class="modal-dialog modal-dialog-popout modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
        <div class="block block-rounded block-themed block-transparent mb-0">
            <div class="block-header">
                <h3 class="block-title">Detail Pemohon</h3>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_registrasi" id="no_registrasi" class="form-control form-control-sm" placeholder="No. Permohonan" value="{{ $data ? $data->no_permohonan : $no_permohonan }}" disabled>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for="" class="fw-bold fs-xs">Nama Pemohon *</label>
                                <input type="text" name="nama_pemohon" id="nama_pemohon" placeholder="Nama Pemohon" class="form-control form-control-sm" value="{{ $data ? $data->nama_pemohon : '' }}" disabled>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for="" class="fw-bold fs-xs">No. WhasApp Pemohon </label>
                                <input type="number" name="telep_pemohon" id="telep_pemohon" placeholder="No. WhatsApp Pemohon" class="form-control form-control-sm" value="{{ $data ? $data->telepon_pemohon : '' }}" disabled>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for="" class="fw-bold fs-xs">Nama Kuasa </label>
                                <input type="text" name="nama_kuasa" id="nama_kuasa" placeholder="Nama Kuasa" class="form-control form-control-sm" value="{{ $data ? $data->nama_kuasa : '' }}" disabled>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for="" class="fw-bold fs-xs">No. WhatsApp Kuasa </label>
                                <input type="number" name="telp_kuasa" id="telp_kuasa" placeholder="No. WhatsApp Kuasa" class="form-control form-control-sm" value="{{ $data ? $data->telepon_kuasa : '' }}" disabled>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_sertifikat" id="no_sertifikat" class="form-control form-control-sm" placeholder="00001" value="{{ $data ? $data->no_sertifikat : '' }}" disabled>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for="" class="fw-bold fs-xs">Provinsi *</label>
                                <input type="text" name="provinsi_id" id="provinsi_id" class="form-control form-control-sm" value="JAWA TIMUR" disabled>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for="" class="fw-bold fs-xs">Kab / Kota *</label>
                                <input type="text" name="kabupaten_id" id="kabupaten_id" class="form-control form-control-sm" value="JOMBANG" disabled>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="" class="fw-bold fs-xs">Kecamatan *</label>
                                <select name="kecamatan_id" id="kec" class="form-control form-control-sm select2" disabled>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="desa_id" id="des" class="form-control form-control-sm des" disabled>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm mb-3" type="file" accept="image/*,.pdf" name="images" id="images-upload" multiple disabled>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm mb-3" type="file" accept="image/*,.pdf" name="file_sertifikat" id="file_sertifikat_upload" disabled>
                            </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <select name="jenis_pemetaan" id="jenis_pemetaan" class="form-control form-control-sm" disabled>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group" id="petugas_lapang_container">
                                ...
                                <select name="petugas_lapang" id="petugas_lapang" class="form-control form-control-sm input-data" disabled>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <select name="proses_pengukuran_lapang" id="proses_pengukuran_lapang" class="form-control form-control-sm input-data" disabled>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <select name="petugas_pemetaan" id="petugas_pemetaan" class="form-control form-control-sm input-data" disabled>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <select name="status_pemetaan" id="status_pemetaan" class="form-control form-control-sm input-data" disabled>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <select name="petugas_su_el" id="petugas_su_el" class="form-control form-control-sm input-data" disabled>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <select name="status_su_el" id="status_su_el" class="form-control form-control-sm input-data" onchange="statusHendler(this)" disabled>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="catatan_su_el" id="catatan_su_el" class="form-control form-control-sm input-data" placeholder="Catatan SU EL" rows="1" style="height: calc(1.5em + 0.50rem + 2px);" disabled>{{ $data ? $data->catatan_su_el : '' }}</textarea>
                            </div>
                        </div>
                        @endif
                        @if(Auth::getUser()->level_user == '1')
                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                ...
                                <select name="upload_bt" id="upload_bt" class="form-control form-control-sm input-data" disabled>
                        ...
                        <div class="col-md-@if(Auth::getUser()->level_user == '1')3 @elseif(Auth::getUser()->level_user == '10')4 @endif mb-3">
                            <div class="form-group">
                                ...
                                <select name="petugas_bt_el" id="petugas_bt_el" class="form-control form-control-sm input-data" disabled>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                ...
                                <select name="status_bt_el" id="status_bt_el" class="form-control form-control-sm input-data" onchange="statusHendler(this)" disabled>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="catatan_bt_el" id="catatan_bt_el" placeholder="Catatan BT EL" class="form-control form-control-sm input-data" rows="1" style="height: calc(1.5em + 0.50rem + 2px);" disabled>{{ $data ? $data->catatan_bt_el : '' }}</textarea>
                            </div>
                        </div>
                        @endif
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" name="file_pendukung" id="file_pendukung" class="form-control form-control-sm input-data" multiple disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="catatan_permohonan" id="catatan_permohonan" cols="30" rows="10" disabled>{{ $data ? $data->catatan_permohonan : '' }}</textarea>
                            </div>
                        </div>
                ...
                <form class="form-save" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="" class="fw-bold fs-xs">Catatan</label>
                                <textarea class="form-control" name="catatan_permohonan" id="catatan_permohonan" cols="30" rows="10">{{ $data ? $data->catatan_permohonan : '' }}</textarea>
                            </div>
                        </div>
                        <div class="col d-flex g-4 mb-4">
                            <button type="button" class="btn btn-secondary fs-sm btn-sm me-2 btn-cancel"><i class="fa fa-fw fa-backward me-1"></i>Kembali</button>
