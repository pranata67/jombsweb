        ...
        <div class="col-xl-12 \">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Data Petugas Lapangan</h3>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = new DataTable('#datagrid', {
            ajax: "{{ route('main-petugas-lapangan') }}",
            processing: true,
            serverSide: true,
            language: {
    ...
    function addRow(){
        $.post("{!! route('form-petugas-lapangan') !!}").done(function(data){
    ...
    function editForm(id){
        console.log('edit');
        $.post("{!! route('form-petugas-lapangan') !!}", {
            id: id
        }).done(function(data) {
            if (data.status == 'success') {
                $('.modal-page').html('');
    ...
    function deleteRow(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("delete-petugas-lapangan") }}',
                    method: 'POST',
                    data: {
                        _method: 'POST',
                        _token: '{{ csrf_token() }}',
