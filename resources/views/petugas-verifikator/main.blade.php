...
@section('breadcrumb')
	@parent
	<li class="active">Petugas Verifikator</li>
@endsection
        ...
        <div class="col-xl-12 \">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Data Petugas Verifikator</h3>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = new DataTable('#datagrid', {
            ajax: "{{ route('main-petugas-verifikator') }}",
            processing: true,
            serverSide: true,
            language: {
    ...
    function addRow(){
        $.post("{!! route('form-petugas-verifikator') !!}").done(function(data){
    ...
    function editForm(id){
        console.log('edit');
        $.post("{!! route('form-petugas-verifikator') !!}", {
            id: id
        }).done(function(data) {
            if (data.status == 'success') {
                $('.modal-page').html('');
    ...
    function deleteRow(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("delete-petugas-verifikator") }}',
                    method: 'POST',
                    data: {
                        _method: 'POST',
                        _token: '{{ csrf_token() }}',
