    ...
    <div class="modal-dialog modal-dialog-popout modal-dialog-centered modal-lg" role="document">
        ...
        <div class="block block-rounded block-themed block-transparent mb-0">
            <div class="block-header">
                <h3 class="block-title">{{ $data ? 'Edit' : 'Tambah' }} Petugas Verifikator</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="jabatan" id="jabatan" @if (!empty($data)) value="{{ $data->jabatan }}" @endif class="form-control" placeholder="Jabatan">
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#btn-submit').click(function () {
            ...
            $.ajax({
                data: data,
                url: "{{ route('store-petugas-verifikator') }}",
                type: "post",
                processData: false,
                contentType: false,
