...
<!-- Header Content -->
<div class="content-header" style="padding-left: 15px !important; padding-right: 15px !important;">
    <!-- Left Section -->
    <div class="space-x-1">
    <!-- Toggle Sidebar -->
    ...
    <div class="dropdown d-inline-block">
        ...
        <div class="p-2">
            ...
            <!-- Toggle Side Overlay -->
            <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
            <a class="dropdown-item" href="{{ route('main-pengaturan') }}" data-toggle="layout" data-action="side_overlay_toggle">
            <i class="far fa-fw fa-building me-1"></i> Settings
            </a>
            <!-- END Side Overlay -->

            <div role="separator" class="dropdown-divider"></div>
            <a class="dropdown-item" id="logout-button" type="button">
                ...
                success: function(response) {
                    if (response.success) {
                        Swal.fire({
                            ...
                            window.location.href = "{{ route('login') }}"; // Ganti dengan URL setelah logout berhasil
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',
